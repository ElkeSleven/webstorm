const apiUrl = 'http://localhost:63342/web-bootstrap/js_fetch_api';
...
*/
function fetchJSON() {
    fetch(apiUrl + 'fetch-tester.html?_ijt=lmup7h604jaogiurk3g3molkin&_ij_reload=RELOAD_ON_SAVE') // (1) (2)
...
function postRequest() {
    ...
    fetch(apiUrl + 'fetch-tester.html?_ijt=lmup7h604jaogiurk3g3molkin&_ij_reload=RELOAD_ON_SAVE', {
        method: 'POST',
